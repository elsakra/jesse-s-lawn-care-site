...
"lawn-mowing-maintenance.md": {
	id: "lawn-mowing-maintenance.md";
...
"spring-fall-general-cleanup.md": {
	id: "spring-fall-general-cleanup.md";
  slug: "spring-fall-general-cleanup";
  body: string;
  collection: "services";
  data: InferEntrySchema<"services">
} & { render(): Render[".md"] };
